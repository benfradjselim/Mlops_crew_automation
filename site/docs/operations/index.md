...
Guides for running Ruptura in production.
...
- [ ] Scrape `GET /api/v2/metrics` in Prometheus for Ruptura self-metrics
- [ ] Alert on `rpt_rupture_index > 3.0` in your Alertmanager
